    ...
    egui::TopBottomPanel::top("top_panel").show(ctx, |ui| {
        egui::menu::bar(ui, |ui| {
            ...
            ui.menu_button("View", |ui| {
                if ui.selectable_label(app_state.current_view == ViewType::Graph, "Graph View").clicked() {
                    app_state.current_view = ViewType::Graph;
                }
                if ui.selectable_label(app_state.current_view == ViewType::Workflow, "Workflow View").clicked() {
                    app_state.current_view = ViewType::Workflow;
                }
                if ui.selectable_label(app_state.current_view == ViewType::ThreeD, "3D View").clicked() {
                    app_state.current_view = ViewType::ThreeD;
                }
                if ui.selectable_label(app_state.current_view == ViewType::Events, "Events View").clicked() {
