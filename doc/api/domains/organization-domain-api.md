# Organization Domain API Documentation

## Overview

The Organization Domain provides Organizational structures within CIM.
...
The Organization domain integrates with other CIM domains through event-driven patterns.
