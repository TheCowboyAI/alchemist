# Person Domain API Documentation

## Overview

The Person Domain provides Person profiles and relationships within CIM.
...
The Person domain integrates with other CIM domains through event-driven patterns.
